...
/**
 * Point on a {@link RoadEdge} defined by a reference to the {@link RoadEdge} and a fraction <i>f</i>, with
 * <i>0 &le; f &le; 1</i>, which defines an exact position on the {@link RoadEdge}.
 */
public class RoadPoint extends io.sharedstreets.barefoot.topology.Point<RoadEdge> {
     ...
     *
     * @param road {@link RoadEdge} object of the point.
     * @param fraction Exact position on the {@link RoadEdge} defined as fraction <i>f</i>, with <i>0
     *        &le; f &le; 1</i>.
     */
    public RoadPoint(RoadEdge road, double fraction) {
        super(road, fraction);
    ...
    /**
     * Gets the geometry of the point on the {@link RoadEdge}.
     *
    ...
    public static RoadPoint fromJSON(JSONObject json, RoadMap map) throws JSONException {
        RoadEdge road = RoadEdge.fromJSON(json, map);
